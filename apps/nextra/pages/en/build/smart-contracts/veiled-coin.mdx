...
After any operation, except rollover, the actual balance is [normalized](#normaliztion) back to 32-bit chunks to maintain efficient decryption.
...
To ensure transparency, the sender also encrypts the transferred amount using the auditors' EKs,
