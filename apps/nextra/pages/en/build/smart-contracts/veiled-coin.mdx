...
It can handle up to 2^16 transfers before requiring a rollover to the actual balance.
...
Veiled balances utilize Homomorphic encryption, allowing arithmetic operations without their decryption.
