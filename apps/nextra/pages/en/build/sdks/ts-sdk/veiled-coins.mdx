...
[//]: # (TODO: publish and add here expo module)
You could use [this]() expo module for `expo` based `react-native` apps.

Or generate `android` and `ios` bindings [here](https://github.com/distributed-lab/aptos-wasm-bindings/tree/feature/uniffi) and integrate in your app as you please.
