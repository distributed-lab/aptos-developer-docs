...
Next operations require generating zk-proofs (ZKPs), and depending on your environment, you need to define `Range Proof` calculation.
...
Пenerate `android` and `ios` bindings [here](https://github.com/distributed-lab/aptos-wasm-bindings) and integrate in your app as you please.
...
Usually you don't need to explicitly call [normalization](/en/build/smart-contracts/veiled-coin#normalization-1)
